...
import com.memandis.remote.utils.app.DATE_FORMATTER_DATE
import com.memandis.remote.utils.app.DATE_FORMATTER_FULL
import com.memandis.remote.utils.app.DATE_FORMATTER_MONTH_YEAR
import org.apache.commons.lang3.time.DateUtils.isSameDay
import java.util.*

class RylyTabDateDelegate(private val dateDialogListener: (Calendar) -> Unit) :
    RylyToolbarBehaviorDelegate<DiaryDateHolder> {
