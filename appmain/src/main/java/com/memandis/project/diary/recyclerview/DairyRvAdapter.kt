...
import com.memandis.appmain.databinding.CardNormalDiaryNewBinding
import com.memandis.project.GlideApp
import com.memandis.remote.datasource.model.diary.DiaryDateHolder
import com.memandis.project.entry.EntryDisplayActivityArgs
...
class DairyRvAdapter(private val diaryDateHolder: DiaryDateHolder? = null) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): DairyViewHolder {
        ...
        return DairyViewHolder( itemBinding)
    }
        ...
        holder.itemViewBinding.cardImageView.apply {
            try {
                GlideApp.with(context!!)
                    .load(item.images?.get(0)?.getImageStorageReference())
                     .into(this)
            } catch(e: Exception) {
...
//                it.findNavController().navigate(R.id.searchMoreEntryDetailAction, b.toBundle())
        ...
        holder.itemViewBinding.overlineTextView.apply {
            ...
            val relativeTime = DateUtils.getRelativeTimeSpanString(
                ...
                DateUtils.HOUR_IN_MILLIS, FORMAT_ABBREV_ALL)
        ...
        holder.itemViewBinding.supportingTextView.apply {
            if(item.title.isNotEmpty()) {
                // val precomputedTextParams: PrecomputedTextCompat.Params =
                    // TextViewCompat.getTextMetricsParams(this)
                // val precomputedText =
                    // PrecomputedTextCompat.create(item.blockInfo[0].content, precomputedTextParams)
                // TextViewCompat.setPrecomputedText(this, precomputedText)
    ...
    class DairyViewHolder( val itemViewBinding: CardNormalDiaryNewBinding) :
